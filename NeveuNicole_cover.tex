...
% recipient data
\title{Cover Letter}
\recipient{Faculty Hiring Committee}{University of Hawai'i at Manoa\\2500 Campus Rd \\ Honolulu, HI 96822}
\date{January 22, 2020}
\opening{Dear Committee Members,}
\closing{Sincerely,\\ \vspace{1.5em}\includegraphics[width=0.4\linewidth]{NN_signature}}

%\enclosure[Attached]{curriculum vit\ae{}}         
\makelettertitle
\input{cover_letters/cover_letter_hawaii}
\makeletterclosing
