...
\begin{itemize}
          \item Study and optimization of Gaussian and Sum Frequency Generated laser pulses in LCLS-II injector.
          \item Working with group members to create/inform uncertainty quantification and surrogate models (machine learning) of LCLS/LCLS-II.
         \item Submitted proposal to Laser Improvement task force for new temporal/logitudinal laser diagnostic. %This will provide a direct measurement of the laser's longitudinal profile.
        ...
        \item Contributing to and managing repository for general data processing Python tools for LCLS, \hyperlink{https://github.com/slaclab/lcls-tools}{\color{blue}\textbf{lcls-tools}}.
        ...
        %\item Simulation of the X-band test facility in TID to support re-start of facility.
         \item Helping with simulations and experimental runs at the X-band test facility in TID.
\end{itemize}
}
