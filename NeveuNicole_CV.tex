...
\cventry{Menlo Park, CA}{SLAC National Accelerator Laboratory}{Associate Scientist}{October 2021--Present}{}{
    Work focused on LCLS operations and LCLS-II comissioning:
    \begin{itemize}
        \item Taking shifts as program deputy for LCLS
        \item Writing Higher Order Mode and operating point GUI for the the LCLS-II injector
         \item Simulation studies of laser offsets on the cathode for LCLS
        \item Contributing to LCLS-II commissioning shifts
        \item Continued management of repository for general data processing Python tools for LCLS,\newline \url{https://github.com/slaclab/lcls-tools}.
    \end{itemize}
}

\cventry{Menlo Park, CA}{SLAC National Accelerator Laboratory}{Research Associate -- Experimental}{December 2018--Present}{}{
Beam dynamics work focused on LCLS/LCLS-II:
\begin{itemize}
          \item Optimization of Gaussian and Sum Frequency Generated laser pulses in LCLS-II injector.
          \item Worked with group members to create/inform uncertainty quantification and surrogate models (machine learning) of LCLS/LCLS-II.
        ...
        \item Contributed to and managed repository for general data processing Python tools for LCLS, \hyperlink{https://github.com/slaclab/lcls-tools}{\color{blue}\textbf{lcls-tools}}.
        ...
        \item Improved PIC simulation models for LCLS/LCLS-II.
...
\cventry{}{}{SLAC Spot Award for Excellence}{2019}{}{}
\vspace{-1.5em}
...
\vspace{-1.5em}
\cventry{}{}{Science Graduate Student Research Award}{2015--2016}{}{}%}
\vspace{-1.5em}
