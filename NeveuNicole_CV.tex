...
\cventry{Menlo Park, CA}{SLAC National Accelerator Laboratory}{Associate Scientist - Diagnostics Department}{October 2021--Present}{}{
    Contributing to LCLS operations and LCLS-II commissioning through research, maintenance, and leadership activities.
    \begin{itemize}
        \item Taking LCLS-II commissioning shifts for:
        \begin{itemize}
         \item wire scanner setup, HOMBOM, and testing of installed diagnostics.
         \item emittance GUI testing and measurements.
         \item beam transport down stream.
        \end{itemize}
        \item Training to become a SME on wire scanner commissioning and installations.
         \item Lead for Higher Order Mode Beam Offset Monitor project (LCLS-II injector).
         \begin{itemize}
             \item ASP submission, CAM, and management of the project.
         \end{itemize}
        \item Taking shifts as program deputy.
        \item Responsible for emittance GUI maintenance and measurement training.
        ...
        \item Contributed to SLAC technical notes.
         ...
         \begin{itemize}
             ...
             \item Participated in planning and instruction at SLACPAS.
...
\begin{itemize}
          ...
          \begin{itemize}
              \item The simulations and models are being used for machine prediction and further ML research at SLAC.
          \end{itemize}
         \item Submitted proposal to Laser Improvement task force for new temporal/longitudinal laser diagnostic.
         \begin{itemize}
        ...
        \begin{itemize}
            \item QE map results were included in the LCLS EIC publication.
        \end{itemize}
...
\section{USPAS Courses}
\cvlistdoubleitem{Microwave Measurements and Beam Instr. }{Fundamentals of Timing and Synchronization}
\cvlistdoubleitem{Accelerator Physics}{Vacuum Science and Technology}
%\newpage
