...
%--------------------------------------------------------------------------------
\name{Nicole}{Neveu}
\extrainfo{PhD in Physics, IIT \& ANL}
...
\address{2575 Sandhill Road}{Menlo Park, CA 94025}{USA}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\section{Education}
\cventry{Chicago, IL}{Illinois Institute of Technology}{Ph.D Candidate in Physics}{2013--2019}{College of Science}{}%{\textit{Grade}}{Description}  % arguments 3 to 6 can be left empty
...
\cventry{Menlo Park, CA}{SLAC National Accelerator Laboratory}{Research Associate}{2019--Present}{}{
Optimization and simulation of LCLS and LCLS-II as part of the \newline
Lightsource Unified Modelling Enviornment (LUME) project.
\newline}

\cventry{Lemont, IL}{Argonne National Laboratory (ANL)}{Graduate Student, Argonne Wakefield Accelerator (AWA)}{2013--2019}{}{
...
\bibliographyrefproc{./cvparts/papers}
