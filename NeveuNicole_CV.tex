...
\newcites{proc}{Conference Proceedings}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Assiting with Early Injector Commisioning (LCLS-II gun)
		\item Taking experimental measurments on LCLS-II gun to characterize machine and verify simulations.
	\end{itemize}
	\item Simulations
	\begin{itemize}
		\item Improving PIC simulation models for LCLS/LCLS-II
		\item Working closely with others to inform surrogate models
		\item Creating data sets for Machine Learning studies
		\item Studying effect of laser profiles w.r.t photoinjector and FEL performance
		\begin{itemize}
			\item Optimization of beam dynamics for Gaussian temporal profiles for LCLS-II
			\item Incorporation of transverse laser profiles using Virtual Cathode Camera images
			\item Simulation optimization and study of general laser profiles
		\end{itemize} 
	\end{itemize}
\end{itemize}
}
...
\section{Teaching}
\cventry{Stony Brook, NY}{Instructor, Optimization and Machine Learning for Accelerators }{USPAS that will be hosted by Stony Brook University}{June 2020}{}{}
...
\cvlistdoubleitem{\cvitem{Proficient in}{OPAL-T, Python, Matlab}}{\cvitem{Prior experience with}{IMPACT, ASTRA, C/C++, Fortran, Perl, SQL}}
